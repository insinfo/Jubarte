        ...
        $('body').ready(function () {
            ...
            $.get('/bit/index.php/feed/', function (data) {
                ...
                $xml.find("item").each(function () {
                    ...
                    var temp = $(template);
                    temp.find('.rssDescription').text(item.description.substring(0, 100) + '...');
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="panel panel-body">
                                    <div class="media no-margin">
                                        <div class="media-body">
                                            <h3 class="no-margin text-semibold" id="usuarios_online">10</h3>
                        ...
                        <div class="row">
                                                    ...
                                                    <!--
                                                     <li class="media stack-media-on-mobile">
                                                         <div class="media-left">
                                                             <div class="thumb">
                                                                 <a href="http://bit.riodasostras.rj.gov.br/index.php/2018/03/12/resumo-da-cartilha-de-seguranca/" target="_blank">
                                                                     <img src="http://bit.riodasostras.rj.gov.br/wp-content/uploads/2017/02/seguranca_bit-760x400.jpg" class="img-responsive img-rounded media-preview thumbnailBIT" alt="Boas práticas no uso da Informação">
                                                                     <span class="zoom-image"><i class="icon-newspaper"></i></span>
                                                                 </a>
                                                             </div>
                                                         </div>
                                                         <div class="media-body">
                                                             <h6 class="media-heading"><a href="http://bit.riodasostras.rj.gov.br/index.php/2018/03/12/resumo-da-cartilha-de-seguranca/" target="_blank">Boas práticas no uso da Informação</a></h6>
                                                             <ul class="list-inline list-inline-separate text-muted mb-5">
                                                                 <li>Administrativo</li>
                                                                 <li>12 de Março de 2018</li>
                                                             </ul>
                                                             A Segurança da Informação é responsabilidade de todos Não acesse as categorias de conteúdo proibidas na Prefeitura ...
                                                         </div>
                                                     </li>
                                                     <li class="media stack-media-on-mobile">
                                                         <div class="media-left">
                                                             <div class="thumb">
                                                                 <a href="http://bit.riodasostras.rj.gov.br/index.php/2018/03/06/configurando-e-restaurando-as-radwins/" target="_blank">
                                                                     <img src="https://rad-stg-9ra4idmgea.netdna-ssl.com/wp-content/uploads/2018/01/Smart-City-page-product-portfolio.png" class="img-responsive img-rounded media-preview thumbnailBIT" alt="Configurando e restaurando as Radwins">
                                                                     <span class="zoom-image"><i class="icon-newspaper"></i></span>
                                                                 </a>
                                                             </div>
                                                         </div>
                                                         <div class="media-body">
                                                             ...
                                                             Neste tutorial vamos mostrar como configurar e restaurar os radios da Radwin, são os equipamentos utilizados nos links...
                                                         </div>
                                                     </li>
                                                     <li class="media stack-media-on-mobile">
                                                         <div class="media-left">
                                                             <div class="thumb">
                                                                 <a href="http://bit.riodasostras.rj.gov.br/index.php/2018/03/05/instalando-backuppc/" target="_blank">
                                                                     <img src="http://bit.riodasostras.rj.gov.br/wp-content/uploads/2018/03/backuppc.png" class="img-responsive img-rounded media-preview thumbnailBIT" alt="Instalando BackupPC">
                                                                     <span class="zoom-image"><i class="icon-newspaper"></i></span>
                                                                 </a>
                                                             </div>
                                                         </div>
                                                         ...
                                                         <div class="media-body">
                                                             ...
                                                             O BackupPC é uma solução de backup corporativo de alto desempenho usado para fazer backups de estações...
                                                         </div>
                                                     </li>-->
                                                </ul>
                                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title"><i class="icon-coins"></i> Demonstrativo de Pagamento de Salário</h6>
                                    </div>
