...
<head>
    ...
    <script type="text/javascript" src="/cdn/Vendor/limitless/material/js/plugins/ui/nicescroll.min.js"></script>
     <script type="text/javascript" src="/ViewModel/Util/SideBarFixedNiceScroll.js"></script>
...
<body id="window" class="navbar-top">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
          ...
          <div class="navbar-right">
              ...
              <ul class="nav navbar-nav right">
                  <li class="">
                      <a id="btnOpenModalBugReport" data-popup="tooltip" title="BugReport" data-placement="bottom" data-toggle="modal" data-target="#modalBugReport">
                          <i class="icon-bug2"></i>
                          <span class="visible-xs-inline-block position-right">BugReport</span>
                      </a>
                  </li>
                  <!--<li class="dropdown" data-popup="tooltip" title="Alertas" data-placement="bottom">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                          <i class="icon-bell2"></i>
                          <span class="visible-xs-inline-block position-right">Alertas</span>
                          <span class="status-mark border-orange-400"></span>
                      </a>

                      <div class="dropdown-menu dropdown-content">
                          <div class="dropdown-content-heading">
                              Alertas Ciente / Pessoal
                              <ul class="icons-list">
                  ...
                  <li class="dropdown" data-popup="tooltip" title="E-Mail" data-placement="bottom">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
    ...
    <div class="page-container containerCustom">
        ...
        <div class="page-content containerCustom">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-user-material">
                        <div class="category-content">
                            <div class="sidebar-user-material-content">
                                <a>
                                    ...
                                    <span class="userThumbnailLarge" style="background: rgb(56, 73, 243);">
                                        <i>LE</i>
                                    </span>
                                </a>
                                <h6 class="displayUserName"></h6>
                                <span class="text-size-small">Servidor</span>
                            </div>
                        ...
                        <div class="navigation-wrapper collapse" id="user-nav">
                            <ul class="navigation">
                                <!--<li>
                                    <a href="/pages/dadosUsuario" target="iframeShowPage">
            ...
            <div class="content-wrapper containerCustom">
                <iframe id="iframeShowPage" src="pages/intranet" scrolling="no" name="iframeShowPage" class="iframeCustom" allowtransparency="false"></iframe>
            </div>
            <!-- /iFrame Main Content -->
